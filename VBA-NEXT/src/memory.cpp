...
extern uint8_t libretro_save_buf[0x10000 + 0x2000];
...
void flashInit (void)
{
	memset(flashSaveMemory, 0xff, 0x10000);
}
...
extern u8 libretro_save_buf[0x10000 + 0x2000];
u8 *eepromData = libretro_save_buf + 0x10000;
